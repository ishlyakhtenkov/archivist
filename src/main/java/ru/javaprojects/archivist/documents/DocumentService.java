...
public class DocumentService {
    ...
    public List<DocumentInvoice> getSendings(long documentId, long companyId) {
        repository.getExisted(documentId);
        companyRepository.getExisted(companyId);
        return documentInvoiceRepository.findAllByDocumentIdAndCompanyId(documentId, companyId);
    }
}
