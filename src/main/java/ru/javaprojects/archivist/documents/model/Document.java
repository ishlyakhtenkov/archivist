...
public class Document extends BaseEntity implements HasId {
    ...
    @Column(name = "secret", nullable = false, columnDefinition = "bool default false")
    ...
    public Document(Long id, String name, String decimalNumber, String inventoryNumber, LocalDate accountingDate,
                    Status status, Symbol symbol, Type type, boolean annulled, boolean secret, String comment, Department developer,
    ...
    public static Document autoGenerate(String decimalNumber) {
        ...
        document.setDecimalNumber(decimalNumber.toUpperCase());
