...
class ChangeNoticeRestControllerTest extends AbstractControllerTest implements TestContentManager {
    private static final String CHANGE_NOTICES_AUTOGENERATED_CHANGES_URL = CHANGE_NOTICES_URL_SLASH + "changes/autogenerated";
    ...
    void getChangesForAutogenerated() throws Exception {
        perform(MockMvcRequestBuilders.get(CHANGE_NOTICES_AUTOGENERATED_CHANGES_URL)
                .param(NAME, changeNotice3.getName())
                .with(csrf()))
