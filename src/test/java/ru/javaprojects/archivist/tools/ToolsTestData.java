...
public class ToolsTestData {
    ...
    public static MultiValueMap<String, String> getNewGroupSendingParams() {
    ...
    public static final MockMultipartFile DECIMAL_NUMBERS_LIST_FILE = new MockMultipartFile("file",
    ...
    public static final GroupAddSendingResult result =
